...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 722.0, 414.0, 150.0, 34.0 ],
					"text" : "<= named subpatch> <num of voices>"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 861.0, 267.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 861.0, 302.0, 59.0, 22.0 ],
					"text" : "voices $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 783.0, 350.0, 150.0, 20.0 ],
					"text" : "<= note bach.llll ######"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 702.0, 349.0, 79.0, 22.0 ],
					"text" : "prepend note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 619.0, 463.0, 150.0, 20.0 ],
					"text" : "busymap"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 566.333333333333371, 463.0, 150.0, 20.0 ],
					"text" : "mutemap"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 886.0, 425.0, 150.0, 34.0 ],
					"text" : "<= INITIALIZE the poly~ voices"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 852.0, 496.0, 60.0, 22.0 ],
					"text" : "s mute.all"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 852.0, 461.0, 59.0, 22.0 ],
					"text" : "mute 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 852.0, 430.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 623.666666666666629, 442.0, 45.0, 22.0 ],
					"text" : "0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.333333333333371, 442.0, 45.0, 22.0 ],
					"text" : "1 1 1 1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 101.0, 188.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 101.0, 143.0, 134.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 58.0, 143.0, 37.0, 20.0 ],
									"text" : "<m>"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 192.0, 64.0, 153.0, 48.0 ],
									"text" : "send bangs every 200 ms, with low priority\n"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 53.0, 64.0, 126.0, 22.0 ],
...
,
					"patching_rect" : [ 476.952475247524944, 377.0, 74.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "", "", "" ],
					"patching_rect" : [ 529.0, 414.0, 191.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 637.0, 541.0, 68.0, 22.0 ],
					"text" : "send~ out2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 558.0, 541.0, 68.0, 22.0 ],
					"text" : "send~ out1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 558.0, 496.0, 54.0, 22.0 ],
					"text" : "*~ 0.707"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 521.0, 258.0, 20.0 ],
					"text" : "(copied and adapted in September 2022, RJB)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 385.0, 389.0, 33.0, 20.0 ],
					"text" : "<m>",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.952475247524944, 349.0, 331.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 73.0, 389.0, 310.0, 22.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 231.0, 349.0, 107.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80100
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 291.0, 93.0, 264.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 291.0, 71.0, 215.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 111.0, 47.0, 53.0, 20.0 ],
					"text" : "<attrui>",
					"textcolor" : [ 0.870588, 0.415686, 0.062745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 111.0, 69.0, 178.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 111.0, 93.0, 178.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 579.452475247524944, 56.333333333333314, 396.0, 89.0 ],
					"text" : "(Instructions from Louis's assignment):\n1. Turn audio on (illuminate <ezdac> or enable <dac> in your out patch).\n2. Play the bach.roll\n3. Double-click on the subpatch called \"monophonic synth\" to see notes on how this \"dirty\" synthesizer works...\n",
					"textcolor" : [ 0.011765, 0.396078, 0.752941, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 134.952475247524831, 125.333333333333314, 73.0, 20.0 ],
					"text" : "<bach.roll>",
					"textcolor" : [ 0.870588, 0.415686, 0.062745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 64.0, 147.333333333333314, 753.952475247524831, 186.666666666666686 ],
					"pitcheditrange" : [ "null" ],
					"ruler" : 3,
					"showplayhead" : 1,
					"stafflines" : [ 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 5.0, 421.0, 29.0 ],
					"text" : "2.1 A Monophonic Synthesizer (RJB)"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 0 ],
					"midpoints" : [ 870.5, 345.0, 792.0, 345.0, 792.0, 399.0, 538.5, 399.0 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				...
				"bootpath" : "~/Desktop/sound-synth-tech/week.3",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
